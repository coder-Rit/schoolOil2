...
exports.genrateOtp_email = catchAsyncErorr(async( req,res,next)=>{
   ...
   let transporter = nodemailer.createTransport({
       ...
       auth: {
           user: "declan.russel@ethereal.email", // generated ethereal user
           pass: "YNmaEJAgPShxkujE2z", // generated ethereal password
       },
   });

   let message = {
       from: '"schoolOil" <declan.russel@ethereal.email>', // sender address
...
exports.genrateOtp_mobile =catchAsyncErorr (async(req,res,next)=>{
      var options = {authorization : "QAvPCVEO3urylZdK6Ixgz1B4p2eUosX9FkMTWj7Hh5bSDwNqRYrb5IR03kv6anKo7wB24lmt9NCsdc8T" , message : ` schoolOil   \n Please enter the following verification code to verify your mobile number.\n ${req.body.OTP}` ,  numbers : ['9119512822']} 
